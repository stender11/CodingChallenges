...
// ---P.R.E.P.---
// takes in draft and crew params as part of an object/class method, which will both be nums only, then compare the values to see what the overall draft value is
// return a boolean depending on if the draft is over 20 meaning the ship is worth looting or not 
// For example:
// titanic.isWorthIt() // return false
// aWorthyShip.isWorthIt() // return true
